...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    if($stat)
    {
        $_SESSION['success'] = "Book Information updated successfully!";
...
<div id="page-wrapper">
    <div class="row">
        <h2 class="page-header">Update Book Information</h2>
    </div>
    <!-- Flash messages -->
    <?php
    ...
    <form class="" action="" method="post" enctype="multipart/form-data" id="contact_form">
        ...
        <?php
            ...
            require_once('./forms/book_registration.php'); 
        ?>
    </form>
</div>
